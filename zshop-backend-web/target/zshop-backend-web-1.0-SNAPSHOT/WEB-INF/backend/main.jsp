    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#order-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/order/findAll");
            });
            ...
            <div class="row user-setting">
                <div class="col-xs-2 user-wrap">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item" name="orderPic" id="order-set">
                            <i class="glyphicon glyphicon-edit"></i> &nbsp;订单管理
                        </li>
