...
public class ShoppingCartUtils {
    ...
    //生成订单购物车
    public static ShoppingCart getOrderCart(HttpSession session){

        ShoppingCart shoppingCart = (ShoppingCart) session.getAttribute("orderCart");
        if (shoppingCart == null){
            shoppingCart = new ShoppingCart();
            session.setAttribute("orderCart",shoppingCart);
        }
        return shoppingCart;
    }
